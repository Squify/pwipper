<div class="pweep grey-thin-border">
    ...
    <div class="icons-pweep">
        ...
        <a href="{{ route('repweep', $pweep->initial_pweep_id ? $pweep->initial_pweep_id : $pweep->id) }}">
            <svg width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-arrow-left-right"
                 fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd"
                      d="M1 11.5a.5.5 0 0 0 .5.5h11.793l-3.147 3.146a.5.5 0 0 0 .708.708l4-4a.5.5 0 0 0 0-.708l-4-4a.5.5 0 0 0-.708.708L13.293 11H1.5a.5.5 0 0 0-.5.5zm14-7a.5.5 0 0 1-.5.5H2.707l3.147 3.146a.5.5 0 1 1-.708.708l-4-4a.5.5 0 0 1 0-.708l4-4a.5.5 0 1 1 .708.708L2.707 4H14.5a.5.5 0 0 1 .5.5z"/>
        ...
        <a href="{{ route('likePweep', $pweep->initial_pweep_id ? $pweep->initial_pweep_id : $pweep->id) }}">
            @if($currentUser->like->contains($pweep))
                <svg style="color: #ffed4a" width="1em" height="1em" viewBox="0 0 16 16" class="bi bi-star-fill" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
